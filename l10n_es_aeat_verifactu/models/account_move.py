...
class AccountMove(models.Model):
    ...
    def _get_verifactu_tax_req(self, tax):
        ...
        taxes_req = self._get_aeat_taxes_map(["RE"], document_date)
    ...
    def _get_verifactu_taxes_and_total(self):
        ...
        document_date = self._get_document_fiscal_date()
        taxes_S1 = self._get_aeat_taxes_map(["S1"], document_date)
        taxes_S2 = self._get_aeat_taxes_map(["S2"], document_date)
        taxes_N1 = self._get_aeat_taxes_map(["N1"], document_date)
        taxes_N2 = self._get_aeat_taxes_map(["N2"], document_date)
